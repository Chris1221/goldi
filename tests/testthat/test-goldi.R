...
out <- structure(c("ribosomal_chaperone_activity", "In this sentence we will talk about ribosomal chaperone activity"), .Dim = 1:2, .Dimnames = list(NULL, c("Identified Terms", "Context" )))
